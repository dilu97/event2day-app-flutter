...
import 'package:event2day/models/blog.dart';
import 'package:event2day/config/config.dart';
import 'package:event2day/pages/comments.dart';
import 'package:event2day/utils/next_screen.dart';
import 'package:event2day/utils/sign_in_dialog.dart';
import 'package:event2day/widgets/bookmark_icon.dart';
import 'package:event2day/widgets/custom_cache_image.dart';
import 'package:event2day/widgets/love_count.dart';
import 'package:event2day/widgets/love_icon.dart';
...
class _BlogDetailsState extends State<BlogDetails> {
  ...
  handleShare() {
    Share.share(
        '${widget.blogData.title}, To read more install ${Config().appName} App. https://play.google.com/store/apps/details?id=com.mrblab.event2day');
  }
